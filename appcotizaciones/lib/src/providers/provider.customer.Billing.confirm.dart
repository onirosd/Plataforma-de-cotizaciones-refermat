                              ...
                              OutlinedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (formGlobalKey.currentState!.validate()) {
                                    ...
                                    var val = 0;
                                    try {
                                      billing.latitude = latitude;
                                      billing.longitude = longitude;
                                      ...
                                      billingCrt
                                        ...
                                        if (val > 0) {
                                          ...
                                          List<Company> arrCompany = await comp
                                              .getCompany(_CodCompany);
