...
class CustomerQuotationCopy extends StatefulWidget {
  CustomerQuotationCopy({Key? key}) : super(key: key);

  @override
  _CustomerQuotationCopyState createState() => _CustomerQuotationCopyState();
}

class _CustomerQuotationCopyState extends State<CustomerQuotationCopy> {
  String _LoginUser = '';
  int _CodUser = 0;
  String _Company = '';
  String _CodCompany = '';
                ...
                onPressed: () async {
                  ...
                  if (_key.currentState!.validate()) {
                    ...
                    try {
                      ...
                      var cod =
                          updQuotation.customerId.toString() + dateAndMoment;
                      updQuotation.id = cod;

                      if (await quotationCrt.insertQuotation(updQuotation) >
                          0) {
